...
Disciplina: Retele Neuronale   Institutie: POLITEHNICA Bucuresti – FIIR   Student: Perpelea George-Lucian   Grupa: 633AB Link Repository GitHub: 
Data: 04.12.2025  
...
Validarea rapida a marcajelor                                   Clasificare pattern binar (string)                            RN Module (Antrenare 
de lot/simbolurilor pe panouri HMI.                             ->Decizie OK/Eroare in < 100 ms                                          neuroni...vi) + UI  


Asigurarea invariantei la usoare variatii                       Clasificare bazata pe MLP, robust la zgomot,                  RN Module(Teach.vi si
de pozitie sau deformare a simbolurilor.                        cu acuratete > 99% (post-antrenare).                          CalculateResponse.vi)

Testarea flexibilitatii sistemului la recunoasterea             Concatenare matrici booleene pentru a clasifica               Data Logging/Acquisition 
grupurilor de simboluri (secvente).                             intregul grup ca o singura clasa unica.                       (GenerareDateSimboluri.vi)
...
Dovezi:
*	Tabel Statistici: Variatia este concentrata pe distributia binara (0/1) a pixelilor si pe numarul de pixeli aprinsi pentru fiecare simbol/grup.
